...
public class TextSwitchView extends TextSwitcher implements ViewSwitcher.ViewFactory {
    ...
    public TextSwitchView(Context context, AttributeSet attrs) {
        ...
        for(int i = 0; i < count; i++) {
            ...
            switch (index) {
                case R.styleable.TextSwitchView_tsvtextColor:
                    mTextColor = ta.getColor(index, Color.BLACK);
                    break;

                case R.styleable.TextSwitchView_tsvtextSize:

                    mTextSize = ta.getDimensionPixelSize(R.styleable.TextSwitchView_tsvtextSize, 24);
                    /*mTextSize = ta.getDimensionPixelSize(index, (int) TypedValue.applyDimension(
